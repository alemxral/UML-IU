...
{{N_CLUSTERS_TEXT}} distinct research clusters were identified and characterized through keyword analysis and manual validation. Table~\ref{tab:clusters} summarizes the cluster characteristics.
...
\newpage
\section{Visualizations and Plots}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{../plots/category_distribution.png}
\caption{Distribution of papers across ArXiv categories. This visualization shows the representation of different scientific domains in the analyzed dataset.}
\label{fig:category_dist}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{../plots/temporal_trends.png}
\caption{Temporal trends in publication volume. The time series analysis reveals how research activity has evolved across the study period.}
\label{fig:temporal}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{../plots/cluster_sizes.png}
\caption{Distribution of papers across identified clusters. The relatively balanced distribution with each cluster containing 19-21\% of papers indicates that the clustering algorithm found five coherent groupings of similar size.}
\label{fig:cluster_sizes}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{../plots/clusters_2d_umap.png}
\caption{Two-dimensional UMAP projection of clusters. This visualization shows the spatial arrangement of papers in reduced dimensionality space, where proximity indicates similarity in research topics.}
\label{fig:clusters2d}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{../plots/category_by_cluster.png}
\caption{Distribution of ArXiv categories within each cluster. This heatmap reveals how traditional subject categories map onto the data-driven clusters, highlighting interdisciplinary connections.}
\label{fig:category_cluster}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{../plots/keyword_heatmap.png}
\caption{Keyword importance heatmap across clusters. Darker colors indicate higher TF-IDF scores, revealing the distinctive vocabulary that characterizes each research cluster.}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{../plots/wordcloud_cluster_0.png}
\caption{Word cloud for Cluster 0. Dominant terms: {{CLUSTER_0_KEYWORDS}}}
\label{fig:wc0}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{../plots/wordcloud_cluster_1.png}
\caption{Word cloud for Cluster 1. Dominant terms: {{CLUSTER_1_KEYWORDS}}}
\label{fig:wc1}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{../plots/wordcloud_cluster_2.png}
\caption{Word cloud for Cluster 2. Dominant terms: {{CLUSTER_2_KEYWORDS}}}
\label{fig:wc2}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{../plots/wordcloud_cluster_3.png}
\caption{Word cloud for Cluster 3. Dominant terms: {{CLUSTER_3_KEYWORDS}}}
\label{fig:wc3}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{../plots/wordcloud_cluster_4.png}
\caption{Word cloud for Cluster 4. Dominant terms: {{CLUSTER_4_KEYWORDS}}}
\label{fig:wc4}
\end{figure}
